...
const projects = [
  {
    image: image,
    title: 'Loopstudio',
    github: 'https://github.com/maracodex/loopstudio',
    live: 'https://loopstudio-landing-page-lyart.vercel.app/',
  },
  {
    image: image1,
    title: 'Travel Journal',
    github: 'https://github.com/maracodez/travel-journal',
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-8">
        {projects.map((project, index) => (
          <div key={index} className="relative group overflow-hidden rounded-xl shadow-lg">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-white px-4">
              <h3 className="text-xl font-bold mb-2">{project.title}</h3>
              <div className="space-x-4">
                <a href={project.github} target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-300">
                  Github
                </a>
                <a href={project.live} target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-300">
                  Live
                </a>
              </div>
            </div>
